...
LORA_TAG_HIGHLIGHT = ("#FF5733", "#FF8C00")  # Orange-red for dark mode, brighter orange for light mode
LORA_NAME_HIGHLIGHT = ("#4CAF50", "#8BC34A")  # Green for dark mode, lighter green for light mode
LORA_WEIGHT_HIGHLIGHT = ("#2196F3", "#64B5F6")  # Blue for dark mode, lighter blue for light mode
